...
export function RoomPaymentComponent() {
    ...
    return <div className="border-2 border-[#29303A] rounded-lg mt-4 lg:p-16 p-4 w-full lg:h-[calc(100vh-250px)] h-[calc(100vh-190px)] overflow-y-scroll">
        ...
        {!screenState.isLedgerConnected &&
            <div className="flex items-center justify-center text-white lg:mt-32 mt-8">
        ...
        {screenState.isLedgerConnected &&
            <div className="lg:flex justify-between items-center lg:mt-12 mt-4 space-y-4 lg:space-y-0">
                ...
                <div className="ml-12 mr-12 items-center">
                    <img src={rightArrow} className="w-12 h-12 m-auto rotate-90 lg:rotate-0"/>
                </div>
                <div className="lg:w-[350px] w-full h-[300px] bg-gray-800 text-white p-4 rounded-xl overflow-hidden">
