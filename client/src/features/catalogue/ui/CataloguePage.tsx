...
export function CataloguePage() {
    const { content, isEmptyVisible, onRefreshClick} = useViewModel()
    const modalsContext = useModalsContext()
    const style = !isEmptyVisible ? "w-screen" : "w-screen h-screen"
            ...
            {!isEmptyVisible && <div>
                <div className="flex justify-between">
                    ...
                    <div 
                        ...
                        className="p-2 bg-[#ffb81c] w-fit rounded-full h-fit hover:opacity-70">
                        <RefreshIcon />
                    </div>
                </div>
