...
export function CreateAccountSection() {
    ...
    return <section>
        <div className="h-20 w-full -rotate-2 opacity-5 bg-[#0c131a] -mt-8"/>
        <div className="w-fit m-auto p-16">
            <h2 className="text-yellow-400 pt-16 font-bold text-center text-md">REGISTER FOR FREE</h2>
            <h1 className="mt-8 text-5xl leading-tight font-bold text-center">Create an account to get <br/> the whole experience</h1>
