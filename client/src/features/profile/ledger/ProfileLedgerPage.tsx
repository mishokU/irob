...
export function ProfileLedgerPage() {
    ...
    return <div>
        <div className="flex space-x-12">
            <div className="w-[500px] border-2 border-[#4a5058] h-fit rounded-lg p-2 items-center relative">
            ...
            <div className="w-fit h-fit border-2 border-[#4a5058] rounded-lg p-2 items-center">
                <h1 className="text-3xl text-white ml-4 mr-4 mt-2">Last ten transactions</h1>
                <div className="max-h-[calc(100vh-300px)] scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-gray-100 overflow-y-scroll">
