    ...
    return <div>
        <div className="flex justify-between">
            <div className="flex space-x-4">
                <Dialog.Title className="text-3xl font-bold text-gray-900">{fakeContent.name}</Dialog.Title>
                <BookmarkOutFilledIcon />
                <ComplaintIcon />
            </div>
            <div className="hover:bg-gray-200 hover:rounded-full p-2" onClick={() => {
                cardContext?.setVisibility(false)
            }}>
        ...
        <div className="flex">
            <div className="flex">
                <div className="max-w-lg pr-16 space-y-4">
                    <div className="mt-4 flex space-x-2 text-black">
